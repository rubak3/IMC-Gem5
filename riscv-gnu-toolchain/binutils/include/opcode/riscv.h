...
#define RISCV_R4TYPE(insn, rd, rs1, rs2, rs3) \
  ((MATCH_ ## insn) | ((rd)  << OP_SH_RD)  | ((rs1) << OP_SH_RS1) | ((rs2) << OP_SH_RS2) | ((rs3) << OP_SH_RS3))
#define RISCV_R4TYPE2(insn, rs1, rs2, rs3, rs4) \
  ((MATCH_ ## insn) | ((rs1) << OP_SH_RS1) | ((rs2) << OP_SH_RS2) | ((rs3) << OP_SH_RS3)) | ((rs4)  << OP_SH_RD)
